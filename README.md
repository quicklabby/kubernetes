...
Since only one mini pc is not enough to run a HA cluster, I installed each node on separated SSD at least in case of a disk failure one of the node should still running.
