...
As the ASUS mini pc is not enough to run a HA cluster, I installed each node on different internal SSDs, as in case of a disk failure one of the node should still running.
